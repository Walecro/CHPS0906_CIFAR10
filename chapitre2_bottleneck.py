...
class my_class(nn.Module):
    def __init__(self,in_channels,out_channels):
        ...
        #Reduce
        self.a = custom_conv(in_channels,out_channels,kernel_size=3)

        #?
        self.b = custom_conv(out_channels,out_channels,kernel_size=3,group_n=1)

        #Augmentation ?
        self.c = custom_conv(out_channels,in_channels)

        self.residual = nn.Conv2d(in_channels, in_channels, kernel_size=19, stride=1, padding=0)
        self.d = nn.Linear(588,nclasses)
